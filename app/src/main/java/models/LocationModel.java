...
public class LocationModel {
	...
	public LocationModel(int user_id, double lat_, double lon_, double speed_,
	...
	public LocationModel(Location l, int userid, int sats, String provider) {
	...
	public LocationModel(Location l, int userid, String provider) {
		// TODO Auto-generated constructor stub
		time_ = l.getTime();
		user_id = userid;
		lat_ = l.getLatitude();
